...
(function initChatbot() {
  ...
  const COSMO_AVATAR_SVG = `<svg width="22" height="22" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="30" cy="28" r="18" fill="#06060f" stroke="#00bfff" stroke-width="1.5"/><ellipse cx="30" cy="28" rx="13" ry="11" fill="#0b0b1a" stroke="#00bfff" stroke-width="1"/><circle cx="24" cy="27" r="3.2" fill="#00bfff" opacity=".9"/><circle cx="36" cy="27" r="3.2" fill="#00bfff" opacity=".9"/><circle cx="24" cy="27" r="1.4" fill="#fff"/><circle cx="36" cy="27" r="1.4" fill="#fff"/><path d="M24 34 Q30 38 36 34" stroke="#00bfff" stroke-width="1.2" stroke-linecap="round" fill="none"/><line x1="30" y1="10" x2="30" y2="6" stroke="#00bfff" stroke-width="1.5"/><circle cx="30" cy="5" r="2" fill="#00bfff"/><rect x="22" y="41" width="16" height="8" rx="3" fill="#06060f" stroke="#00bfff" stroke-width="1"/></svg>`;
